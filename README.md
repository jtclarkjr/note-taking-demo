...
Created using: 
```
pnpx create-tsrouter-app my-app --template file-router
```

The default readme says TanStack has a store why not use that?
[Response from Tanner himself](https://www.reddit.com/r/reactjs/comments/1cnddul/comment/l38we0p/?utm_source=share&utm_medium=web3x&utm_name=web3xcss&utm_term=1&utm_content=share_button)
